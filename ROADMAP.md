...
- [ ] **RSS Feed** — ajouter `src/pages/rss.xml.ts` pour l'indexation dans les agrégateurs
- [ ] **Table des matières** — sommaire ancré en sticky à droite pour les longs articles
