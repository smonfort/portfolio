const fr = {
  ...
  skills: {
    ...
    // Maps expertise category keys (from expertises.ts) to display names
    categories: {
    ...
    // Maps expertise item keys (from expertises.ts) to display names
    items: {
      // Leadership
      techLeadership: 'Tech leadership',
      solutionArchitecture: 'Architecture de solutions',
      businessOrientation: 'Orientation business',
      agility: 'Agilité',
